...
<body class="container pb-3">
    <h1 class="mt-3 mb-3">Modificar empleado</h1>
    <!-- aca pasamos nuevamente por la url el id de la persona -->
    <form <?php echo"action='./update_empleado.php?ID_EMPLEADO=".$id."'"; ?> method="post">
        <div class="col-auto">
        ...
        <div class="col-auto">
            ...
            <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Ingresa usuario" <?php echo"value='".$result['USUARIO']."'"; ?> required>
        </div>
        <div class="col-auto">
            <label for="staticEmail2">Password</label>
            <input type="text" class="form-control" id="password" name="password" placeholder="Ingresa password" <?php echo"value='".$result['PASSWORD']."'"; ?> required>
        </div>
