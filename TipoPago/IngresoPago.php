...
<body class="container d-flex flex-column justify-content-center pt-4 pb-4">
    <main class="container">
        <div class="row g-3 form-control">
            <h1 class="mb-4"> Registro de Formas del pago</h1>
        </div>
        <form class="row g-3 form-control" action="./registrar_tipo_pago.php" method="post">
            <div class="col-auto">
                <label for="staticEmail2">Nombre del tipo</label>
                <input type="text" class="form-control" id="nombre_pago" name="nombre_pago" placeholder="Ingresa el nombre del servicio">
            </div>
